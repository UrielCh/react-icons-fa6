...
/**
 * reativeCommonsPd icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsPd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsPd;
