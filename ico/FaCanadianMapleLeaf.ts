...
/**
 * anadianMapleLeaf icon from Font Awesome 6
 * @module
 */
export function FaCanadianMapleLeaf(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCanadianMapleLeaf;
