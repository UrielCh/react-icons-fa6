...
/**
 * reativeCommonsBy icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsBy(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsBy;
