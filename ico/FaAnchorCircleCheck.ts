...
/**
 * nchorCircleCheck icon from Font Awesome 6
 * @module
 */
export function FaAnchorCircleCheck(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaAnchorCircleCheck;
