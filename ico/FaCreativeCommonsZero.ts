...
/**
 * reativeCommonsZero icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsZero(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsZero;
