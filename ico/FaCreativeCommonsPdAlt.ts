...
/**
 * reativeCommonsPdAlt icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsPdAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsPdAlt;
