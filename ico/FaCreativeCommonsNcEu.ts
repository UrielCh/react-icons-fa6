...
/**
 * reativeCommonsNcEu icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsNcEu(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsNcEu;
