...
/**
 * aceGrinTongueSquint icon from Font Awesome 6
 * @module
 */
export function FaFaceGrinTongueSquint(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaFaceGrinTongueSquint;
