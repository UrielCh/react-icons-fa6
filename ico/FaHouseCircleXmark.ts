...
/**
 * ouseCircleXmark icon from Font Awesome 6
 * @module
 */
export function FaHouseCircleXmark(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaHouseCircleXmark;
