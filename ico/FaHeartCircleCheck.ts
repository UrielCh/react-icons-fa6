...
/**
 * eartCircleCheck icon from Font Awesome 6
 * @module
 */
export function FaHeartCircleCheck(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaHeartCircleCheck;
