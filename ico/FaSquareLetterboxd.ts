...
/**
 * quareLetterboxd icon from Font Awesome 6
 * @module
 */
export function FaSquareLetterboxd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaSquareLetterboxd;
