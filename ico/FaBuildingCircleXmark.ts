...
/**
 * uildingCircleXmark icon from Font Awesome 6
 * @module
 */
export function FaBuildingCircleXmark(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaBuildingCircleXmark;
