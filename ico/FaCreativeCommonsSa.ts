...
/**
 * reativeCommonsSa icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsSa(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsSa;
