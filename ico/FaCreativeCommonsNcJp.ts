...
/**
 * reativeCommonsNcJp icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsNcJp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsNcJp;
