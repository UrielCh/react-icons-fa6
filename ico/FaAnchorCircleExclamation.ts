...
/**
 * nchorCircleExclamation icon from Font Awesome 6
 * @module
 */
export function FaAnchorCircleExclamation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaAnchorCircleExclamation;
