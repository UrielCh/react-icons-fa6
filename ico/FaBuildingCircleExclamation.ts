...
/**
 * uildingCircleExclamation icon from Font Awesome 6
 * @module
 */
export function FaBuildingCircleExclamation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaBuildingCircleExclamation;
