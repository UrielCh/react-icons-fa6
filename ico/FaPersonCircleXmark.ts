...
/**
 * ersonCircleXmark icon from Font Awesome 6
 * @module
 */
export function FaPersonCircleXmark(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaPersonCircleXmark;
