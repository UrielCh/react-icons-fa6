...
/**
 * acebookMessenger icon from Font Awesome 6
 * @module
 */
export function FaFacebookMessenger(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaFacebookMessenger;
