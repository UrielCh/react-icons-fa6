...
/**
 * reativeCommonsNc icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsNc(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsNc;
