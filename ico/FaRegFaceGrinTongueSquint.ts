...
/**
 * egFaceGrinTongueSquint icon from Font Awesome 6
 * @module
 */
export function FaRegFaceGrinTongueSquint(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegFaceGrinTongueSquint;
