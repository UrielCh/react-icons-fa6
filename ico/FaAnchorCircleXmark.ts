...
/**
 * nchorCircleXmark icon from Font Awesome 6
 * @module
 */
export function FaAnchorCircleXmark(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaAnchorCircleXmark;
