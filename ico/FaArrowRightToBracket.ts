...
/**
 * rrowRightToBracket icon from Font Awesome 6
 * @module
 */
export function FaArrowRightToBracket(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaArrowRightToBracket;
