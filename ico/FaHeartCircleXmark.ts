...
/**
 * eartCircleXmark icon from Font Awesome 6
 * @module
 */
export function FaHeartCircleXmark(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaHeartCircleXmark;
