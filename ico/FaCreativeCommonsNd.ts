...
/**
 * reativeCommonsNd icon from Font Awesome 6
 * @module
 */
export function FaCreativeCommonsNd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaCreativeCommonsNd;
